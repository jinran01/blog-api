...
import com.fiee.fieeblog.dto.ChatRecordDTO;
import com.fiee.fieeblog.dto.RecallMessageDTO;
import com.fiee.fieeblog.dto.WebsocketMessageDTO;
import com.fiee.fieeblog.entity.ChatRecord;

import com.fiee.fieeblog.service.ChatRecordService;
import com.fiee.fieeblog.utils.BeanCopyUtils;
import com.fiee.fieeblog.utils.HTMLUtils;
import com.fiee.fieeblog.utils.IpUtils;
import com.fiee.fieeblog.vo.VoiceVO;
import lombok.Data;
...
import static com.fiee.fieeblog.enums.ChatTypeEnum.*;
...
public class WebSocketServiceImpl {
    ...
    private CopyOnWriteArraySet<WebSocketServiceImpl> webSocketSet = new CopyOnWriteArraySet<>();

    @Autowired
    public void setChatRecordService(ChatRecordService chatRecordService) {
        WebSocketServiceImpl.chatRecordService = chatRecordService;
    }
    ...
    public void onOpen(Session session, EndpointConfig endpointConfig) throws IOException {
        ...
        System.out.println(chatRecordDTO);
        // 发送消息
    ...
    private ChatRecordDTO listChartRecords(EndpointConfig endpointConfig) {
        System.out.println(chatRecordService);
        // 获取聊天历史记录
        List<ChatRecord> chatRecordList = chatRecordService.list(new LambdaQueryWrapper<ChatRecord>()
